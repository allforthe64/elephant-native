  ...
  return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.container}>      
                <AppPressable
                  testID={TestIds.dashboard.scan}
                  accessibilityLabel="Document Scanner"
                  onPress={() => navigate('Document Scanner')}
                ...
                <AppPressable
                  testID={TestIds.dashboard.camera}
            ...
            <View style={styles.container}>
                <AppPressable
                  testID={TestIds.dashboard.qr}
                  accessibilityLabel="QR Scanner"
                  onPress={() => navigate('QR Scanner')}
                  style={styles.buttonWrapper}
                >
                  <View style={styles.iconContainer}>
                ...
                <AppPressable
                  testID={TestIds.dashboard.mic}
                  accessibilityLabel="Record Audio"
                  onPress={() => navigate('Record Audio')}
                  style={styles.buttonWrapper}
                >
                  <View style={styles.iconContainer}>
            ...
            <View style={{width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'center'}}>
              <AppPressable
                ...
                style={{display: 'flex', flexDirection: 'row', alignItems: 'center', width: '96%', backgroundColor: '#DDCADB', marginTop: '2%', borderRadius: 10, paddingTop: 6, paddingBottom: 6, paddingLeft: '15%'}}
              >
